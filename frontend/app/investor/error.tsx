...
export default function InvestorError({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Vault data unavailable</h2>
        <p className="text-gray-400 max-w-md">Could not load investor vaults. Check your wallet connection and try again.</p>
      </div>
      <button
        onClick={reset}
